...
var reportDataService = new ReportDataService(connectionString, databaseName!);

var ui = new UserInterface(stackService, cardService, sessionService, reportDataService);
ui.Run();