...
{
    private static List<FlashCardWithCleanId> LaunderFlashCardId(List<FlashCard> flashCards)
    {
        int cleanID = 1;
    ...
    private static int GetFlashCardID(int stackID)
    {
    ...
    private static void ViewFlashCard(int stackID)
    {
        Console.Clear();
